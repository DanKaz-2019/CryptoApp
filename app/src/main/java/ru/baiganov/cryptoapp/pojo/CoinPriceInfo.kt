package ru.baiganov.cryptoapp.pojo
...
import ru.baiganov.cryptoapp.api.ApiFactory.BASE_IMAGE_URL
import ru.baiganov.cryptoapp.util.convertTimestampToTime
...
data class CoinPriceInfo (
    ...
    @Expose
    val conversionOnType: String? = null,
